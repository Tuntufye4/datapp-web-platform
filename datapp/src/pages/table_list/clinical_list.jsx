...
export default function ClinicalTablePage() {                         
  ...
  // Export to CSV
  const exportCSV = () => {
    const headers = ["ID","Disease","Treatment","Diagnosis","Symptoms"];
    const csvRows = [
        ...
        <div className="bg-white rounded-xl shadow overflow-x-auto">
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                {["ID","Disease","Treatment","Diagnosis","Symptoms"].map(h => (
            ...
            <tbody>
              ...
              {filteredRows.length === 0 && (
                <tr><td className="px-3 py-4 text-gray-500" colSpan={6}>No matching clinical details</td></tr>
              )}
            </tbody>
          </table>
        </div>
